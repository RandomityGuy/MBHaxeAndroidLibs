...
public class SDLActivity extends Activity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.arg1) {
                ...
                case COMMAND_CHANGE_WINDOW_STYLE:
                    ...
                    /*
                     * This needs more testing, per bug 4096 - Enabling fullscreen on Android causes
                     * the app to toggle fullscreen mode continuously in a loop
                     ***/
                    // if (context instanceof Activity) {
                    //     Window window = ((Activity) context).getWindow();
                    //     if (window != null) {
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint) {
        ...
        Log.v("SDL", "setOrientation() orientation=" + orientation + " width=" + w + " height=" + h + " resizable="
                + resizable + " hint=" + hint);
        if (orientation != -1) {
    ...
    /**
     * com.android.vending.expansion.zipfile.ZipResourceFile's getInputStream() or
     * null.
     */
